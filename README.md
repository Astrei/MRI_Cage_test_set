...
A concept of using a set of antennas to find an RF cage wall problem. 
...
It is also possible to use it to find a source of external RF interference that affects MR-image quality. In this example, an old power supply in the cabinet has some problems.
